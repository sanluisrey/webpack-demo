...
it("should export the same binding", () => {
	return Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./module */ 0)).then(ns => {
		expect(_module__WEBPACK_IMPORTED_MODULE_0__["default"]).toBe(ns.default);
	});
});
