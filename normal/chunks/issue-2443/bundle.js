...
/* 0 */
/*!*********************************************!*\
  !*** ./chunks/issue-2443/dir/three/file.js ***!
  \*********************************************/
...
/* 2 */
/*!*************************************************************************!*\
  !*** ./chunks/issue-2443/dir/ lazy ^\.\/.*\/file\.js$ namespace object ***!
  \*************************************************************************/
/*! default exports */
...
it("should be able to use expressions in import (directory)", function(done) {
	function load(name, expected, callback) {
		__webpack_require__(2)("./" + name + "/file.js")
	...
	if (Math.random() < 0) __webpack_require__(/*! ./dir/three/file */ 0);
	load("one", 1, function() {
		load("two", 2, function() {
