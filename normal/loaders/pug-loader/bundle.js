...
function pug_rethrow(err, filename, lineno, str) {
  ...
  try {
    str = str || (__webpack_require__(/*! fs */ 5).readFileSync)(filename, {encoding: 'utf8'});
    context = 3;
    lines = str.split('\n');
...
var pug = __webpack_require__(/*! !../../../../node_modules/pug-runtime/index.js */ 0);
...
/* 2 */
/*!*************************************************************************************!*\
  !*** ../../node_modules/pug-loader/index.js?self!./loaders/_resources/template.pug ***!
  \*************************************************************************************/
/*! unknown exports (runtime-defined) */
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var self = locals || {};pug_html = pug_html + ("\u003Cp\u003E" + (pug.escape(null == (pug_interp = typeof abc === "undefined" ? "self" + self.abc : abc) ? "" : pug_interp)) + "\u003C\u002Fp\u003E" + (null == (pug_interp = (__webpack_require__(/*! ./included.pug */ 1).call)(this, locals)) ? "" : pug_interp));;return pug_html;};
module.exports = template;
...
function template(locals) {var pug_html = "", pug_mixins = {}, pug_interp;;
    ...
    (function (abc, self) {
      pug_html = pug_html + ("\u003Cp\u003E" + (pug.escape(null == (pug_interp = typeof abc === "undefined" ? "self" + self.abc : abc) ? "" : pug_interp)) + "\u003C\u002Fp\u003E" + (null == (pug_interp = (__webpack_require__(/*! ./included.pug */ 1).call)(this, locals)) ? "" : pug_interp));
...
it("should handle the pug loader correctly", function() {
	expect(__webpack_require__(/*! !pug-loader?self!../_resources/template.pug */ 2)({ abc: "abc" })).toBe("<p>selfabc</p><h1>included</h1>");
	expect(__webpack_require__(/*! ../_resources/template.pug */ 3)({ abc: "abc" })).toBe("<p>abc</p><h1>included</h1>");
});
