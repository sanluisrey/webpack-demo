...
/*!******************************************************!*\
  !*** ./scope-hoisting/circular-root-export/index.js ***!
  \******************************************************/
...
it("should hoist exports in a concatenated module", () => {
	return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(__webpack_require__, /*! ./root-ref */ 1)).then(m => {
		m.test();
	});
});

if (Math.random() < 0) __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(__webpack_require__, /*! ./external-ref */ 2));
