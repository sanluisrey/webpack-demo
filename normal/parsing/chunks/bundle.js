...
it("should parse a Coffeescript style function expression in require.ensure", function(done) {
	__webpack_require__.e(/*! require.ensure */ 0).then((function(_this) {
...
it("should parse a string in require.ensure with arrow function array expression", function(done) {
	__webpack_require__.e(/*! require.ensure */ 0).then((require => (expect(__webpack_require__(/*! ./file */ 1)).toBe("ok"), done())).bind(null, __webpack_require__))['catch'](__webpack_require__.oe);
});
