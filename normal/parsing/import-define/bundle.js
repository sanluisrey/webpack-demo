...
/* 1 */
/*!*****************************************!*\
  !*** ./parsing/import-define/module.js ***!
  \*****************************************/
/*! namespace exports */
...
/* harmony export */   "Z": () => (/* binding */ define)
/* harmony export */ });
...
(() => {
/*!****************************************!*\
  !*** ./parsing/import-define/index.js ***!
  \****************************************/
/*! namespace exports */
...
it("should allow to import a variable named define (call)", () => {
	expect((0,_module__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z)()).toBe("ok");
});

it("should allow to import a variable named define (expresion)", () => {
	const d = i(_module__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .Z);
	expect(d()).toBe("ok");
});
