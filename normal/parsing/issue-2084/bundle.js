...
(() => {
/*!*************************************!*\
  !*** ./parsing/issue-2084/index.js ***!
  \*************************************/
/*! unknown exports (runtime-defined) */
/*! runtime requirements: __webpack_require__, __webpack_require__.oe, __webpack_require__.e, __webpack_require__.* */
...
it("should bind this context on require callback", function(done) {
	...
	runWithThis({ok: true}, function() {
		Promise.resolve(/*! AMD require */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = []; (function() {
			try {
				expect(__webpack_require__(/*! ./file */ 0)).toBe("file");
...
it("should bind this context on require callback (loaded)", function(done) {
	runWithThis({ok: true}, function() {
		__webpack_require__.e(/*! AMD require */ 0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(/*! ./load.js */ 2)]; (function(load) {
			try {
				expect(__webpack_require__(/*! ./file */ 0)).toBe("file");
...
it("should bind this context on require callback (foo)", function(done) {
	var foo = {ok: true};
	Promise.resolve(/*! AMD require */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = []; (function(load) {
		try {
			expect(__webpack_require__(/*! ./file */ 0)).toBe("file");
			expect(this).toEqual({ok: true});
			done();
		} catch(e) { done(e); }
	}.bind(foo)).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this))['catch'](__webpack_require__.oe);
});
...
it("should bind this context on require callback (foo)", function(done) {
	runWithThis({ok: true}, function() {
		...
		}.bind({ok: this})).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}.bind(this))['catch'](__webpack_require__.oe);
	});
});
