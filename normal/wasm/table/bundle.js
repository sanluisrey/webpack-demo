...
it("should support tables", function () {
	return __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.bind(__webpack_require__, /*! ./wasm-table.wat */ 2)).then(function (wasm) {
...
it("should support exported tables", function () {
	return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(__webpack_require__, /*! ./wasm-table-export.wat */ 1)).then(function (wasm) {
...
it("should support imported tables", function () {
	return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(__webpack_require__, /*! ./wasm-table-imported.wat */ 3)).then(function (wasm) {
		expect(wasm.callByIndex(0)).toEqual(42);
		expect(wasm.callByIndex(1)).toEqual(13);
		expect(() => wasm.callByIndex(2)).toThrow(UNKNOWN_FUNCTION_TABLE);
	});
