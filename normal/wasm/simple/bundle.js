...
it("should allow to run a WebAssembly module (indirect)", function() {
	return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(__webpack_require__, /*! ./module */ 1)).then(function(module) {
...
it("should allow to run a WebAssembly module (direct)", function() {
	return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(__webpack_require__, /*! ./wasm.wat?2 */ 2)).then(function(wasm) {
