...
/*!****************************************!*\
  !*** ./wasm/two-files-loader/index.js ***!
  \****************************************/
...
it("should be able to create two modules from loader", function() {
	return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(__webpack_require__, /*! ./wrapper-loader!./src/wasm.dat */ 1)).then(function(wasm) {
...
it("should be able to create two modules from loader with remaining request", function() {
	return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(__webpack_require__, /*! ./wrapper-loader2!./src/wasm.dat?2 */ 2)).then(function(wasm) {
		expect(wasm.getString()).toEqual("Hello World");
	});
});
