...
/*!********************************************!*\
  !*** ./optimize/many-exports-120/index.js ***!
  \********************************************/
...
it("should mangle all exports correctly x", () => {
	return __webpack_require__.e(/*! import() */ 0).then(__webpack_require__.bind(__webpack_require__, /*! ./chunk1 */ 1)).then(({ default: test }) => {
		test();
	});
});
it("should mangle all exports correctly y", () => {
	return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.bind(__webpack_require__, /*! ./chunk2 */ 2)).then(({ default: test }) => {
		test();
	});
});
