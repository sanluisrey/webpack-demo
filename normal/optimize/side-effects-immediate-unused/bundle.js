...
(() => {
/*!*********************************************************!*\
  !*** ./optimize/side-effects-immediate-unused/index.js ***!
  \*********************************************************/
/*! namespace exports */
...
it("should not evaluate an immediate module", function() {
	...
	expect(pmodule__WEBPACK_IMPORTED_MODULE_1__.z).toBe("z");
	expect(pmodule_tracker__WEBPACK_IMPORTED_MODULE_2__/* .log */ .cM).toEqual(["a.js", "c.js"]);
});
