...
(() => {
/*!*************************************************************************************************!*\
  !*** ../_helpers/entryLoader.js?{"usedExports":[],"expect":{"lodash-es":[]},"name":"nothing"}! ***!
  \*************************************************************************************************/
/* harmony import */ var lodash_es__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash-es */ 326);
if (Math.random() < 0) __webpack_require__(/*! ../_helpers/testModuleLoader?[]! */ 913);


it("nothing should have the correct exports used for lodash-es", () => {
expect(lodash_es__WEBPACK_IMPORTED_MODULE_0__/* .__usedExports */ .b).toEqual(["__usedExports"]);
});
