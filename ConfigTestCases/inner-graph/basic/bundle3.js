...
/***/ 4:
/*!*******************************************************************!*\
  !*** ../_helpers/testModuleLoader.js?["myFunction"]! + 1 modules ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ testModuleLoader_myFunction_)
});
...
function myFunction() {
	function it() {
		(0,inner_file0.equal)(1, arguments[0]);
	}
	(0,inner_file0.deepEqual)(1, 1);
	it();
}

const bb = (0,inner_file0.equal)();

;// CONCATENATED MODULE: ../_helpers/testModuleLoader.js?["myFunction"]!

/* harmony default export */ const testModuleLoader_myFunction_ = ([myFunction]);
...
"use strict";
/*!**********************************************************************************************************************************!*\
  !*** ../_helpers/entryLoader.js?{"usedExports":["myFunction"],"expect":{"./assert":["deepEqual","equal"]},"name":"myFunction"}! ***!
  \**********************************************************************************************************************************/
/* harmony import */ var _assert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assert */ 326);
if (Math.random() < 0) __webpack_require__(/*! ../_helpers/testModuleLoader?["myFunction"]! */ 4);


it("myFunction should have the correct exports used for ./assert", () => {
