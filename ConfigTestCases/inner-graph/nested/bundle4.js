...
const __usedExports = ["__usedExports","equal"];
...
/***/ 505:
/*!*************************************************!*\
  !*** ../_helpers/testModuleLoader.js?["fun6"]! ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ([_module__WEBPACK_IMPORTED_MODULE_0__/* .fun6 */ .C]);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "C": () => (/* binding */ fun6)
/* harmony export */ });
/* unused harmony export fun5 */
...
function fun6() {
	(0,_assert__WEBPACK_IMPORTED_MODULE_0__.equal)(1, 1);
}
...
"use strict";
/*!**********************************************************************************************************!*\
  !*** ../_helpers/entryLoader.js?{"usedExports":["fun6"],"expect":{"./assert":["equal"]},"name":"fun6"}! ***!
  \**********************************************************************************************************/
/* harmony import */ var _assert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assert */ 326);
if (Math.random() < 0) __webpack_require__(/*! ../_helpers/testModuleLoader?["fun6"]! */ 505);


it("fun6 should have the correct exports used for ./assert", () => {
expect(_assert__WEBPACK_IMPORTED_MODULE_0__/* .__usedExports */ .b).toEqual(["__usedExports","equal"]);
});
