...
const __usedExports = ["__usedExports","equal","getNameA","getNameB"];
...
/***/ 379:
/*!*******************************************************************!*\
  !*** ../_helpers/testModuleLoader.js?["ExportCls2"]! + 1 modules ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ testModuleLoader_ExportCls2_)
});
...
;// CONCATENATED MODULE: ../_helpers/testModuleLoader.js?["ExportCls2"]!

/* harmony default export */ const testModuleLoader_ExportCls2_ = ([ExportCls2]);
...
"use strict";
/*!********************************************************************************************************************************************!*\
  !*** ../_helpers/entryLoader.js?{"usedExports":["ExportCls2"],"expect":{"./assert":["getNameA","getNameB","equal"]},"name":"ExportCls2"}! ***!
  \********************************************************************************************************************************************/
/* harmony import */ var _assert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assert */ 326);
if (Math.random() < 0) __webpack_require__(/*! ../_helpers/testModuleLoader?["ExportCls2"]! */ 379);


it("ExportCls2 should have the correct exports used for ./assert", () => {
expect(_assert__WEBPACK_IMPORTED_MODULE_0__/* .__usedExports */ .b).toEqual(["__usedExports","equal","getNameA","getNameB"]);
});
