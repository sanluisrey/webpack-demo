...
const __usedExports = ["__usedExports","definiteEqual","getNameA","getNameB"];
...
/***/ 761:
/*!*******************************************************************!*\
  !*** ../_helpers/testModuleLoader.js?["ExportCls7"]! + 1 modules ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ testModuleLoader_ExportCls7_)
});
...
;// CONCATENATED MODULE: ../_helpers/testModuleLoader.js?["ExportCls7"]!

/* harmony default export */ const testModuleLoader_ExportCls7_ = ([ExportCls7]);
...
"use strict";
/*!****************************************************************************************************************************************************!*\
  !*** ../_helpers/entryLoader.js?{"usedExports":["ExportCls7"],"expect":{"./assert":["getNameA","getNameB","definiteEqual"]},"name":"ExportCls7"}! ***!
  \****************************************************************************************************************************************************/
/* harmony import */ var _assert__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./assert */ 326);
if (Math.random() < 0) __webpack_require__(/*! ../_helpers/testModuleLoader?["ExportCls7"]! */ 761);


it("ExportCls7 should have the correct exports used for ./assert", () => {
expect(_assert__WEBPACK_IMPORTED_MODULE_0__/* .__usedExports */ .b).toEqual(["__usedExports","definiteEqual","getNameA","getNameB"]);
});
