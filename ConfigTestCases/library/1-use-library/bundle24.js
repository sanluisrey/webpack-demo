...
;// CONCATENATED MODULE: external "(require(\"../0-create-library/global-iife-runtimeChunk/runtime.js\"), require(\"../0-create-library/global-iife-runtimeChunk/main.js\"), globalName.x.y)"
const main_js_globalName_x_y_namespaceObject = (require("../0-create-library/global-iife-runtimeChunk/runtime.js"), require("../0-create-library/global-iife-runtimeChunk/main.js"), globalName.x.y);
...
it(
	"should be able to import harmony exports from library (" + "global-iife-runtimeChunk" + ")",
	function () {
