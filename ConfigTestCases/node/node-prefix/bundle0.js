...
it("should allow importing node builtin modules with the node: prefix", () => {
	expect(__webpack_require__(/*! node:fs */ 561)).toBe(__webpack_require__(/*! fs */ 147));
	expect(__webpack_require__(/*! node:path */ 411)).toBe(__webpack_require__(/*! path */ 17));
	expect((external_node_vm_default())).toBe((external_vm_default()));
});
