...
var y = x => () => x
const external_fs_namespaceObject_1 = x({ ["default"]: () => __WEBPACK_EXTERNAL_MODULE_fs__["default"] });
...
;// CONCATENATED MODULE: external ["fs","promises"]
var external_fs_promises_x = y => { var x = {}; __webpack_require__.d(x, y); return x; }
var external_fs_promises_y = x => () => x
const external_fs_promises_namespaceObject_1 = __WEBPACK_EXTERNAL_MODULE_fs__.promises;
var external_fs_promises_default_0 = /*#__PURE__*/__webpack_require__.n(external_fs_promises_namespaceObject_1);
...
it("should be possible to import multiple module externals", () => {
	expect(external_fs_namespaceObject_1["default"]).toBe((external_fs_default()));
	expect(external_path_namespaceObject_1["default"]).toBe((external_path_default()));
	expect((external_fs_promises_default_0())).toBe((external_fs_promises_default()));
});
