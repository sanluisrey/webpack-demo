...
it("should move externals in chunks into entry chunk", function(done) {
	...
	__webpack_require__.e(/*! import() */ 52).then(__webpack_require__.t.bind(__webpack_require__, /*! ./chunk */ 52, 19)).then(function(chunk) {
		expect(chunk.default.a).toBe(3);
		chunk.default.b.then(function(chunk2) {
			expect(chunk2.default).toBe(7);
			Promise.resolve(/*! import() */).then(__webpack_require__.t.bind(__webpack_require__, /*! external3 */ 808, 23)).then(function(ex) {
