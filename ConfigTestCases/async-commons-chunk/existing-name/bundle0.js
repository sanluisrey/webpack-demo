...
it("should not have duplicate chunks in blocks", function (done) {
	...
	__webpack_require__.e(/*! require.ensure | a */ "a").then((function (require) {
	...
	Promise.all(/*! require.ensure | a+b */[__webpack_require__.e("a"), __webpack_require__.e("a+b")]).then((function (require) {
			expect(__webpack_require__(/*! ./a */ 847)).toBe("a");
	...
	Promise.all(/*! require.ensure | a+b+c */[__webpack_require__.e("a"), __webpack_require__.e("a+b"), __webpack_require__.e("a+b+c")]).then((function (require) {
			expect(__webpack_require__(/*! ./a */ 847)).toBe("a");
			expect(__webpack_require__(/*! ./b */ 996)).toBe("b");
