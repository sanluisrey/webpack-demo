...
/******/ 			return "" + chunkId + "-" + {"388":"4a22ab65cd564bcdc706","662":"0d64514cb18312de2017"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
it("should allow to create a WebWorker", async () => {
	const worker = new external_worker_threads_namespaceObject.Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(388), __webpack_require__.b));
