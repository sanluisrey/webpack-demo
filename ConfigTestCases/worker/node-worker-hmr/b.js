...
;// CONCATENATED MODULE: ./index.js?b


it("should allow to create a WebWorker", async () => {
	const worker = new external_worker_threads_namespaceObject.Worker(
		new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(721), __webpack_require__.b)
	);
...
/******/ 			return "" + chunkId + "." + {"662":"0d64514cb18312de2017","721":"7a3d9773f42d2b5d16d6"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("b." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
