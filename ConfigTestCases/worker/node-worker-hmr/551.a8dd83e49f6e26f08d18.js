...
;// CONCATENATED MODULE: ./worker.js?a


external_worker_threads_namespaceObject.parentPort.on("message", async data => {
	const { upper } = await __webpack_require__.e(/*! import() */ 662).then(__webpack_require__.bind(__webpack_require__, /*! ./module */ 662));
	external_worker_threads_namespaceObject.parentPort.postMessage(`data: ${upper(data)}, thanks`);
});
...
/******/ 			return "" + chunkId + "." + "0d64514cb18312de2017" + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("0297952d4c2d2a5eaa20." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
