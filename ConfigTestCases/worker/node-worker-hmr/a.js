...
;// CONCATENATED MODULE: ./index.js?a


it("should allow to create a WebWorker", async () => {
	const worker = new external_worker_threads_namespaceObject.Worker(
		new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(551), __webpack_require__.b)
	);
...
/******/ 			return "" + chunkId + "." + {"551":"a8dd83e49f6e26f08d18","662":"0d64514cb18312de2017"}[chunkId] + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("a." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
