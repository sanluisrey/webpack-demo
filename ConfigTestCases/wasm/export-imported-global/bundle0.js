...
it("should export imported global", function() {
	return __webpack_require__.e(/*! import() */ 662).then(__webpack_require__.bind(__webpack_require__, /*! ./module */ 662)).then(function({ v, w, x, test }) {
...
/******/ 		
/******/ 						try {
/******/ 							readFile(join(__dirname, "" + {"662":{"110":"9dc09ccb8819a82fc74c"}}[chunkId][wasmModuleId] + ".module.wasm"), function(err, buffer){
/******/ 								if (err) return reject(err);
/******/ 		
/******/ 								// Fake fetch response
/******/ 								resolve({
