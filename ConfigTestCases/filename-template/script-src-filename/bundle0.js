...
eval("it(\"should allow to access __webpack_get_script_filename__ \", done => {\n\tconst oldFn = __webpack_require__.u;\n\t__webpack_require__.u = chunk => {\n\t\tconst filename = oldFn(chunk);\n\t\treturn filename + \".changed\";\n\t};\n\t__webpack_require__.e(/*! import() */ \"test_js\").then(__webpack_require__.t.bind(__webpack_require__, /*! ./test.js */ \"./test.js\", 23)).then(\n\t\t() => {\n\t\t\tdone.fail(\"Loading chunk should fail\");\n\t\t},\n\t\terr => {\n\t\t\texpect(err.code).toBe(\"ENOENT\");\n\t\t\texpect(err.path).toMatch(/\\.js\\.changed$/);\n\t\t\tdone();\n\t\t}\n\t);\n});\n\n\n//# sourceURL=webpack:///./index.js?");
