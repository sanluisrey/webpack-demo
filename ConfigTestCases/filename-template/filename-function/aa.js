...
eval("it(\"should be able to load a chunk\", async () => {\n\tawait expect(\n\t\t__webpack_require__.e(/*! import() | 1 */ \"1\").then(__webpack_require__.bind(__webpack_require__, /*! ./chunk1 */ \"./chunk1.js\"))\n\t).resolves.toMatchObject({ default: 1 });\n});\n\n\n//# sourceURL=webpack:///./a.js?");
