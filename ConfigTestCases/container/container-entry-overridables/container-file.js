...
var moduleMap = {
	"./test": () => {
		return __webpack_require__.e(393).then(() => (() => ((__webpack_require__(/*! ./test */ 393)))));
	}
};
...
/******/ 			514: () => (loadFallback("default", "value", () => (__webpack_require__.e(998).then(() => (() => (__webpack_require__(/*! ./value */ 998)))))))
/******/ 		};
