...
/******/ 			var cssChunks = {"chunk_js-_43b61":1,"d_css":1};
...
it("b should load a chunk with css", () => {
	...
	const promise = __webpack_require__.e(/*! import() */ "chunk_js-_43b61").then(__webpack_require__.bind(__webpack_require__, /*! ./chunk */ 52));
...
it("b should load a css chunk", () => {
	const linkStart = document.getElementsByTagName("link").length;
	const scriptStart = document.getElementsByTagName("script").length;
	const promise = __webpack_require__.e(/*! import() */ "d_css").then(__webpack_require__.bind(__webpack_require__, /*! ./d.css */ 429));
