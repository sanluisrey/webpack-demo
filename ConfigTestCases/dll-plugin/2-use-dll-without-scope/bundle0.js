...
var dll = __webpack_require__("../0-create-dll/d.js");
// EXTERNAL MODULE: delegated ./e1.js from dll-reference ../0-create-dll/dll.js
var delegated_e1from_dll_reference_0_create_dll_dll = __webpack_require__("../0-create-dll/e1.js");
// EXTERNAL MODULE: delegated ./e2.js from dll-reference ../0-create-dll/dll.js
var delegated_e2from_dll_reference_0_create_dll_dll = __webpack_require__("../0-create-dll/e2.js");
;// CONCATENATED MODULE: ./e.js



// EXTERNAL MODULE: delegated ./e.js from dll-reference ../0-create-dll/dll.js
var delegated_efrom_dll_reference_0_create_dll_dll = __webpack_require__("../0-create-dll/e.js");
// EXTERNAL MODULE: delegated ./h.js from dll-reference ../0-create-dll/dll.js
var delegated_hfrom_dll_reference_0_create_dll_dll = __webpack_require__("../0-create-dll/h.js");
// EXTERNAL MODULE: delegated ./h1.js from dll-reference ../0-create-dll/dll.js
var delegated_h1from_dll_reference_0_create_dll_dll = __webpack_require__("../0-create-dll/h1.js");
...
it("should load a module from dll", function () {
	expect(__webpack_require__(/*! ../0-create-dll/a */ "../0-create-dll/a.js")).toBe("a");
});

it("should load a module of non-default type without extension from dll", function () {
	expect(__webpack_require__(/*! ../0-create-dll/f */ "../0-create-dll/f.jsx")).toBe("f");
});

it("should load an async module from dll", function (done) {
	__webpack_require__(/*! ../0-create-dll/b */ "../0-create-dll/b.js")()
		.then(function (c) {
...
it("should load a module with loader applied", function () {
	expect(__webpack_require__(/*! ../0-create-dll/g.abc.js */ "../0-create-dll/g.abc.js")).toBe("number");
});
...
it("should be able to reference side-effect-free reexport-only module", function () {
	expect(delegated_h1from_dll_reference_0_create_dll_dll.A).toBe("A");
});
...
/***/ "../0-create-dll/h1.js":
/*!*******************************************************************!*\
  !*** delegated ./h1.js from dll-reference ../0-create-dll/dll.js ***!
  \*******************************************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = (__webpack_require__(/*! dll-reference ../0-create-dll/dll.js */ "dll-reference ../0-create-dll/dll.js"))(236);
